...
- `integration/`: application/process-boundary smoke checks; live PostgreSQL/MinIO coverage is
  ...
  `HIVEBLOT_RUN_LIVE_STRUCTURED_EDITOR=1`, `HIVEBLOT_RUN_LIVE_SPATIAL_EDITOR=1`, or
  `HIVEBLOT_RUN_LIVE_PIPELINE=1`. The queue suite seeds and removes 10,000 cases; the workbench
